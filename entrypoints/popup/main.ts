...
document.querySelector<HTMLDivElement>("#app")!.innerHTML = `
  ...
  <h3>On Sutta Central.net</h3>
    ...
    <li>on all pages <kbd>u</kbd> will copy the bare url</li>
    <li>on all pages <kbd>l</kbd> will copy a link to the current page in markdown format, e.g. <code>[DN 1 Brahmajālasutta](https://suttacentral.net/dn1/en/sujato)</code></li>
